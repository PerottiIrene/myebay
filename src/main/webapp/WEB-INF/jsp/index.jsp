			...
			<main class="flex-shrink-0">
			  <div class="container">
				  ...
				  <button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close" ></button>
					...
					<div class="alert alert-succes alert-dismissible fade show ${succesMessage==null?'d-none':'' }" role="alert">
				  ${succesMessage}
				  <button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close" ></button>
				</div>
			  ...
			  <div class="container px-4 py-5" id="featured-3">
			    <div class="row g-4 py-5 row-cols-1 row-cols-lg-3">
			      <div class="feature col">
			        ...
			        <h2>Gestione annunci temporanea</h2>
			        <p>Paragraph of text beneath the heading to explain the heading. We'll add onto it with another sentence and probably just keep going until we run out of words.</p>
			        <a href="${pageContext.request.contextPath}/gestioneAnnuncio/search" class="icon-link">
