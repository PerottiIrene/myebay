		...
		<div class="container">
			...
			<div class='card'>
				...
				<div class='card-footer'>
					<form action="${pageContext.request.contextPath}/gestioneAnnuncio/executeDelete" method="post">
					<input type="hidden" name="idAnnuncio" value="${delete_annuncio_attr.id}">
					 	<button type="submit" name="submit" value="submit" id="submit" class="btn btn-danger">Conferma eliminazione</button>
					 	
					 	<a href="${pageContext.request.contextPath}/gestioneAnnuncio/list" class='btn btn-outline-secondary'
